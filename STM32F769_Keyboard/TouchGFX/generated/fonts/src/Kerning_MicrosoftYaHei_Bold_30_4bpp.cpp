...
KEEP extern const touchgfx::KerningNode kerning_MicrosoftYaHei_Bold_30_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x004C, -3 },  // (First char = [0x004C, L], Second char = [0x002A, asterisk], Kerning dist = -3)
    ...
    { 0x0050, -5 },  // (First char = [0x0050, P], Second char = [0x002E, period], Kerning dist = -5)
    ...
    { 0x002A, -2 },  // (First char = [0x002A, asterisk], Second char = [0x004A, J], Kerning dist = -2)
